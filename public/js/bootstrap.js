...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.input-zip-code').on('input', function () {
    ...
    if (zipCode.length <= 5) {
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).val(zipCode);
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).val(zipCode.slice(0, 5) + '-' + zipCode.slice(5, 8));
    }
  });
});
  ...
  $('#save-weather').on('click', function () {
    $.ajax({
      ...
      data: {
        ...
        _token: $('meta[name="csrf-token"]').attr('content') // Adicione o CSRF token
      },
      success: function success(response) {
        $('#message').html("<div class=\"alert alert-success\">".concat(response.message, "</div>"));
      },
      error: function error(xhr) {
        $('#message').html("<div class=\"alert alert-danger\">".concat(xhr.responseJSON.message, "</div>"));
      }
    });
  });
});
...
/******/ 	__webpack_require__.O(undefined, ["css/style"], () => (__webpack_require__("./resources/js/weather.js")))
