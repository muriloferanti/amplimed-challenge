...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {
  ...
  function menu() {
    function closeMenu() {
      jquery__WEBPACK_IMPORTED_MODULE_0__('#side-menu').removeClass('open');
    }
    jquery__WEBPACK_IMPORTED_MODULE_0__('#hamburger').click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__('#side-menu').toggleClass('open');
    });
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__(document).click(function (e) {
      if (!jquery__WEBPACK_IMPORTED_MODULE_0__(e.target).closest('#side-menu, #hamburger').length) {
        closeMenu();
      }
    });
